...
const CardTwo = () => {
  ...
  return (
    <>
      <div className="w-full bg-whiteshadow-sm lg:px-10 lg:py-5 p-6 rounded-lg">
        <div className="flex justify-between items-center">
          <div className="lg:w-3/5">
            ...
            <Link
              ...
              className="lg:w-1/3  text-xs font-serif font-medium inline-block mt-5 px-8 py-3 bg-[#D9AA34] text-center text-white rounded-full hover:text-white contact-btn"
              target="_blank"
            >
