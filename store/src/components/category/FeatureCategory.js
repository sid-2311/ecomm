        ...
        <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-6">
          {data[0]?.children?.map((category, i) => (
            <li className="group" key={i + 1}>
              <div className="flex w-full h-full  shadow-sm bg-whitep-4 cursor-pointer transition duration-200 ease-linear transform group-hover:shadow-lg">
                <div className="flex items-center">
                  ...
                  <div className="pl-4">
                    <h3
                      ...
                      className="text-sm text-[#D9AA34] font-medium leading-tight line-clamp-1 group-hover:text-orange-500"
                    >
                      {showingTranslateValue(category?.name)}
                    </h3>
