...
const Category = () => {
  ...
  return (
    <div className="flex flex-col w-full h-full bg-whitecursor-pointer scrollbar-hide">
      {categoryDrawerOpen && (
        <div className="w-full flex justify-between items-center h-16 px-6 py-4 bg-[#D9AA34] text-white border-b border-gray-100">
      ...
      <div className="w-full max-h-full">
        ...
        {isLoading ? (
          ...
          <div className="relative grid gap-2 p-6 bg-black text-white">
