...
const Search = ({ products, attributes }) => {
  ...
  return (
    <Layout title="Search" description="This is search page">
      <div className="mx-auto max-w-screen-2xl px-3 sm:px-10 bg-black text-white">
          ...
          <div className="flex w-full">
            <div className="w-full">
              ...
              {productData?.length === 0 ? (
                <div className="mx-auto p-5 my-5 bg-black">
                  <Image
                ...
                <div className="flex justify-between my-3 bg-orange-100 border border-gray-100 rounded p-3">
                  ...
                  <span className="text-sm font-serif">
                    <select
                      ...
                      className="py-0 text-sm font-serif font-medium block w-full rounded border-0 bg-whitepr-10 cursor-pointer focus:ring-0"
                    >
