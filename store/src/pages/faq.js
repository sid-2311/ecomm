          ...
          <div className="grid gap-4 lg:mb-8 items-center md:grid-cols-2 xl:grid-cols-2">
            ...
            <div className="">
              <Disclosure>
                {({ open }) => (
                  <>
                    <Disclosure.Button className="flex justify-between w-full px-4 py-3 text-base font-medium text-left text-[#D9AA34] focus:text-[#D9AA34] bg-black hover:bg-emerald-50 rounded-lg focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
                      <span>
                      ...
                      <ChevronUpIcon
                        className={`${
                          open ? "transform rotate-180 text-[#D9AA34]" : ""
                        } w-5 h-5 text-[#D9AA34]`}
                      />
                    </Disclosure.Button>
                    <Disclosure.Panel className="px-4 pt-3 pb-8 text-sm leading-7 text-[#D9AA34]">
                      {showingTranslateValue(
              ...
              <Disclosure as="div" className="mt-2">
                {({ open }) => (
                  <>
                    <Disclosure.Button className="flex justify-between w-full px-4 py-3 text-base font-medium text-left text-gray-600 focus:text-[#D9AA34] bg-gray-50 hover:bg-emerald-50 rounded-lg focus:outline-none">
                      <span>
                        {" "}
                        {showingTranslateValue(
              ...
              <Disclosure>
                {({ open }) => (
                  <>
                    <Disclosure.Button className="flex justify-between w-full px-4 py-3 text-base font-medium text-left text-gray-600 focus:text-[#D9AA34] bg-gray-50 hover:bg-emerald-50 rounded-lg focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
                      <span>
                        {" "}
                        {showingTranslateValue(
