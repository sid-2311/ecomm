    ...
    <Layout title="Invoice" description="order confirmation page">
      {isLoading ? (
        ...
        <div className="max-w-screen-2xl mx-auto py-10 px-3 sm:px-6">
          ...
          <div className="bg-whiterounded-lg shadow-sm">
            <Invoice
              data={data}
              printRef={printRef}
              currency={currency}
            ...
            />
            <div className="bg-whitep-8 rounded-b-xl">
                ...
                >
                  {({ blob, url, loading, error }) =>
                    loading ? (
                      ...
                      <button className="mb-3 sm:mb-0 md:mb-0 lg:mb-0 flex items-center justify-center bg-[#D9AA34]  text-white transition-all font-serif text-sm font-semibold h-10 py-2 px-5 rounded-md">
                        {showingTranslateValue(
