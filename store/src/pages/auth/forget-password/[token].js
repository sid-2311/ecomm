  ...
  return (
    <>
      ...
      <div className="h-screen flex items-center justify-center bg-gray-100">
        <div className="bg-whiterounded-lg shadow max-w-md w-full space-y-8 py-12 px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="grid grid-cols-1 gap-5">
              ...
              <button
                disabled={loading}
                type="submit"
                className="w-full text-center py-3 rounded bg-[#D9AA34] font-medium text-sm text-white hover:bg-emerald-600 transition-all focus:outline-none my-1"
              >
