  ...
  return (
    <div className="pb-16 lg:pb-0 xl:pb-0 bg-black text-white">
      <div className="mx-auto max-w-screen-2xl px-4 sm:px-10">
              ...
              <ul className="text-sm flex flex-col space-y-3">
                <li className="flex items-baseline">
                  <Link
                    ...
                    className="text-gray-600 inline-block w-full hover:text-[#D9AA34]"
                  >
                    <CMSkeleton
                      count={1}
                      height={10}
        ...
        <div className="mx-auto max-w-screen-2xl px-4 sm:px-10 bg-black shadow-sm border border-gray-50 rounded-lg">
            ...
            <div className="col-span-1 text-center hidden lg:block md:block">
              {storeCustomizationSetting?.footer?.bottom_contact_status && (
                <div>
                  ...
                  <h5 className="text-2xl font-bold text-[#D9AA34] leading-7">
                    {/* +012345-67900 */}
